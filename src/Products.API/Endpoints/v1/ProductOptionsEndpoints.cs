...
{
    public static RouteGroupBuilder MapProductOptionsV1Endpoints(this IVersionedEndpointRouteBuilder builder)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Results.Created($"/api/v1/products/{productId}/options/{createdDTO.Id}", createdDTO);
    }
